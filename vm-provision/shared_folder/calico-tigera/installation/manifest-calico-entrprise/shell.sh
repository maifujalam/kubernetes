...
curl https://docs.tigera.io/manifests/ocp/crds/01-crd-authentication.yaml -o manifests/01-crd-authentication.yaml
curl https://docs.tigera.io/manifests/ocp/crds/01-crd-applicationlayer.yaml -o manifests/01-crd-applicationlayer.yaml
...
curl https://docs.tigera.io/manifests/ocp/crds/01-crd-eck-beat.yaml -o manifests/01-crd-eck-beat.yaml
curl https://docs.tigera.io/manifests/ocp/crds/01-crd-eck-enterprisesearch.yaml -o manifests/01-crd-eck-enterprisesearch.yaml
curl https://docs.tigera.io/manifests/ocp/crds/01-crd-eck-elasticmapsserver.yaml -o manifests/01-crd-eck-elasticmapsserver.yaml
curl https://docs.tigera.io/manifests/ocp/crds/01-crd-eck-agent.yaml -o manifests/01-crd-eck-agent.yaml
curl https://docs.tigera.io/manifests/ocp/crds/01-crd-imageset.yaml -o manifests/01-crd-imageset.yaml
...
curl https://docs.tigera.io/manifests/ocp/crds/01-crd-monitor.yaml -o manifests/01-crd-monitor.yaml
...
curl https://docs.tigera.io/manifests/ocp/crds/01-crd-managementcluster.yaml -o manifests/01-crd-managementcluster.yaml
...
curl https://docs.tigera.io/manifests/ocp/crds/calico/kdd/crd.projectcalico.org_deeppacketinspections.yaml -o manifests/crd.projectcalico.org_deeppacketinspections.yaml
...
curl https://docs.tigera.io/manifests/ocp/crds/calico/kdd/crd.projectcalico.org_packetcaptures.yaml -o manifests/crd.projectcalico.org_packetcaptures.yaml
...
curl https://docs.tigera.io/manifests/ocp/crds/calico/kdd/crd.projectcalico.org_uisettings.yaml -o manifests/crd.projectcalico.org_uisettings.yaml
curl https://docs.tigera.io/manifests/ocp/crds/calico/kdd/crd.projectcalico.org_uisettingsgroups.yaml -o manifests/crd.projectcalico.org_uisettingsgroups.yaml
